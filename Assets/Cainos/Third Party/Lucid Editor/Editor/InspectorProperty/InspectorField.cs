...
namespace Cainos.LucidEditor
{
    public class InspectorField : InspectorProperty
    {
        ...
        private void DrawSerializeReferenceField(Rect position, InspectorField property)
        {
            ...
            // Utilisez GetObjectReferenceValue pour obtenir la valeur sous-jacente
            object managedReferenceValue = property.serializedProperty.objectReferenceValue;

            buttonLabel.text = (managedReferenceValue == null ? "Null" : managedReferenceValue.GetType().Name) +
